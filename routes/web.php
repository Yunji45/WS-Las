...
use App\Http\Controllers\Backend\AktualController;
...
Route::group(['middleware' => ['web', 'auth', 'role:admin,superadmin']], function(){
    ...
    Route::group(['role' => 'admin,superadmin'], function(){
        ...
        Route::get('/aktual-create',[AktualController::class,'create'])->name('aktual.create');
        Route::post('/aktual/save',[AktualController::class,'store'])->name('aktual.save');
        Route::get('/aktual/delete/{id}',[AktualController::class,'destroy'])->name('aktual.delete');
